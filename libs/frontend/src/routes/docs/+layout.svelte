...
<Container class="flex md:flex-row">
	<SideNavigation>
		<SideNavigationItem href={frontendUrls.DOCS} text="General" />
		<SideNavigationGroup text="Profile">
			<SideNavigationItem href={frontendUrls.DOCS_ACTIVITY} text="Activity" />
		</SideNavigationGroup>
	</SideNavigation>
