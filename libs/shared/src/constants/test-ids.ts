...
export const testIds = {
	...
	PUZZLES_CREATE_PAGE_INPUT_TITLE: "puzzles-create-page-input-title",
	PUZZLES_CREATE_PAGE_INPUT_DESCRIPTION:
		"puzzles-create-page-input-description",
	PUZZLES_CREATE_PAGE_BUTTON_CREATE_PUZZLE:
		"puzzles-create-page-button-create-puzzle",
	...
	LOGIN_FORM_ALERT_ERROR: "login-form-alert-error",
	...
	MULTIPLAYER_PAGE_INPUT_INVITE_CODE: "multiplayer-page-input-invite-code",
	MULTIPLAYER_PAGE_COUNTDOWN_TIMER: "multiplayer-page-countdown-timer",
	MULTIPLAYER_PAGE_PLAYERS_LIST: "multiplayer-page-players-list",
	...
	CUSTOM_GAME_DIALOG_INPUT_INVITE_CODE: "custom-game-dialog-input-invite-code",
	...
	JOIN_BY_INVITE_DIALOG_INPUT_CODE: "join-by-invite-dialog-input-code",
	...
	MAINTENANCE_PAGE_BUTTON_GITHUB: "maintenance-page-button-github",
	MAINTENANCE_PAGE_BUTTON_TWITCH: "maintenance-page-button-twitch",
	...
	GAME_COMPONENT_CODE_EDITOR: "game-component-code-editor",
	GAME_COMPONENT_LANGUAGE_SELECTOR: "game-component-language-selector",
	GAME_COMPONENT_TIMER: "game-component-timer",
	...
	REGISTER_FORM_ALERT_ERROR: "register-form-alert-error",
